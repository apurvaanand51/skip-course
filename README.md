# This tool is built by Apurva Anand.
...
## step 1 - git clone https://github.com/apurvaanand51/skip-course (if you do not have git installed on you pc you can download zip file by clicking on the code button and then unzip it)
...
## python -m apurva.main <name of course extracted from link>